...
<head>
<meta charset="utf-8">
<title>Penza Consulting HTML Template | Our Services</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
        	...
        	<div class="auto-container">
            	<div class="clearfix">
                    ...
                    <div class="top-left top-links">
                    	<ul class="clearfix">
                        	<li><a href="services.html#">Welcome to Consulting Service</a></li>
                        </ul>
                    </div>
                            ...
                            <nav class="main-menu">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="services.html#">Projects</a>
                                            <ul>
    ...
    <!--What We Do--->
    <section class="what-we-do no-bg">
    	<div class="auto-container">
        	<!--Title-->
            ...
            <div class="row clearfix">
            	...
            	<div class="left-column col-md-8 col-sm-12 col-xs-12">
                	<div class="outer">
                        <div class="row clearfix">
                            <!--Service Block One-->
                            <div class="service-block-one col-md-6 col-sm-6 col-xs-12">
                            	<div class="inner-box">
            	...
            	<div class="image-column col-md-4 col-sm-12 col-xs-12">
                	<figure class="image-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="images/resource/featured-image-4.jpg" alt=""></figure>
                </div>
    ...
    <section class="fluid-section-one">
    	<div class="outer-container clearfix">
            ...
            <div class="left-column">
            	<div class="clearfix">
                	<div class="inner">
                    	<div class="title"><h3>We're here to help you</h3></div>
                        <div class="text">Get a weekly email of our pros' current thinking about financial investing egieas, and personal finance..Get a weekly email of our pros' curren.</div>
                        <!--Info List-->
                        <ul class="info-list clearfix">
                        	<li><div class="icon"><span class="flaticon-technology-1"></span></div>Have any questions? <br>800-343-3548</li>
                            <li><div class="icon"><span class="flaticon-shapes-1"></span></div>Chat with a representative</li>
                            <li><div class="icon"><span class="flaticon-location-pin"></span></div>Find an Investor Center near you</li>
                            <li><div class="icon"><span class="flaticon-support"></span></div>Online Counselling is available</li>
                        </ul>
                        <div class="text">Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua quis </div>
                    </div>
                </div>
            </div>
            ...
            <div class="right-column">
            	<div class="clearfix">
                	<div class="inner">
                    	<div class="title"><h3>Sign up for our service view points!</h3></div>
            ...
            <div class="carousel-outer">
            	<div class="single-item-carousel owl-theme owl-carousel">
                    ...
                    <div class="slide">
                        ...
                        <div class="text">RT @ENVATO: ONE SUBSCRIPTION, 5000+ ASSETS & UNLIMITED DOWNLOADS; ELEMENTS IS OUT OF BETA! SIGN UP AT <a href="services.html#">ENVA.TO/ELEMENTS</a>. HTTPS://T.CO…</div>
                        <div class="info">Follow us on <a href="services.html#">Twitter</a> for our latest updates</div>
                    </div>
                    <!--Slide-->
                    <div class="slide">
                    	<div class="icon-box"><span class="fa fa-twitter"></span></div>
                    ...
                    <div class="footer-column col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget posts-widget">
                            ...
                            <div class="widget-content">
                                <!--Post-->
                                <div class="post">
                                	<figure class="post-thumb img-circle"><a href="services.html#"><img class="img-circle" src="images/resource/post-thumb-1.jpg" alt=""></a></figure>
                                    <div class="text"><a href="services.html#">Proffesional solutions for your business.</a></div>
                                    <div class="post-meta">
                                        <ul class="clearfix">
                                            <li><a href="services.html#">Dec 30, 2016</a></li>
                                            <li><a href="services.html#"><span class="fa fa-commenting-o"></span> 2 Comments</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!--Post-->
                                <div class="post">
                                	<figure class="post-thumb img-circle"><a href="services.html#"><img class="img-circle" src="images/resource/post-thumb-2.jpg" alt=""></a></figure>
                                    <div class="text"><a href="services.html#">Money Market Rates Finding the in 2016</a></div>
                                    <div class="post-meta">
                                        <ul class="clearfix">
                                            <li><a href="services.html#">Dec 18, 2016</a></li>
                                            <li><a href="services.html#"><span class="fa fa-commenting-o"></span> 8 Comments</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
